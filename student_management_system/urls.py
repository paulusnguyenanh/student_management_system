...
urlpatterns = [
    ...
    path('staff_text', HodViews.staff_text, name='staff_text'),
    path('staff_csv', HodViews.staff_csv, name='staff_csv'),
    path('staff_pdf', HodViews.staff_pdf, name='staff_pdf'),
    path('upload_staff', HodViews.upload_staff, name='upload_staff'),
